 ...
 *
 */
const Datime = function( timestamp )
{
	this.date = Type( timestamp, Number ) ? new Date( timestamp * 1000 ) : new Date();
};
 ...
 * @return String
 */
Datime.prototype.day = function( f )
{
	if( Type( f, String ) )
	{
		switch( f )
 ...
 * @return String
 */
Datime.prototype.month = function( f )
{
	if( Type( f, String ) )
	{
		switch( f )
 ...
 * @return String
 */
Datime.prototype.years = function( f )
{
	if( Type( f, String ) )
	{
		switch( f )
		...
		return( Fmt( "Invalid format year {}", f ) );
	}
 ...
 * @return String
 */
Datime.prototype.hours = function( f )
{
	if( Type( f, String ) )
	{
		switch( f )
		...
		return( Fmt( "Invalid format hours {}", f ) );
	}
 ...
 * @return String
 */
Datime.prototype.minute = function()
{
 ...
 * @return String
 */
Datime.prototype.second = function()
{
 ...
 * @return String
 */
Datime.prototype.format = function( string )
{
	// Self instance.
	var self = this;
 ...
 *
 */
Datime.prototype.format.formats = {
